...
const updateReportStatus = async (req, res) => {
    try {
        ...
        const report = await reportSchema_1.default.findByIdAndUpdate(reportId, {
            status,
            ...(adminNote !== undefined && { adminNote })
        }, { new: true }).populate('reportedUserId', 'fullName email phone bloodGroup profileImageUrl')
...
exports.default = updateReportStatus;
