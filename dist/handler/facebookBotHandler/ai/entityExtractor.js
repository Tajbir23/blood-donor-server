...
exports.extractHospitalLocation = extractHospitalLocation;
exports.extractBagCount = extractBagCount;
exports.detectUrgency = detectUrgency;
...
exports.getDistrictCoordinates = getDistrictCoordinates;
exports.getDivisionCoordinates = getDivisionCoordinates;
 ...
 */
function extractHospitalLocation(text) {
 ...
 */
function getThanaCoordinates(thanaId) {
    for (const division of bangladeshGeoLoactionData_1.bangladeshGeoData.divisions) {
        for (const district of division.districts) {
            const thana = district.thanas.find(t => t.id === thanaId);
            if (thana)
                return { latitude: thana.latitude, longitude: thana.longitude };
        }
    }
    return null;
}
