...
const getDonationHistory_1 = __importDefault(require("../controller/user/getDonationHistory"));
...
userRouter.get('/donation-history', verifyJwt_1.default, getDonationHistory_1.default);
