...
export async function handleTgAiMessage(chatId: string, text: string): Promise<boolean> {
    try {
        ...
        await sendTgInlineKeyboard(
            chatId,
            "🤔 আপনার কথাটি পুরোপুরি বুঝতে পারিনি।\n\n" +
            "একটু সহজ করে লিখলে ভালো হয়, যেমন:\n" +
            "• <i>\"A+ রক্ত দরকার ঢাকায়\"</i>\n" +
            "• <i>\"আমি ডোনার হতে চাই\"</i>\n" +
            "• <i>\"কতদিন পর রক্ত দেওয়া যায়?\"</i>\n\n" +
            "অথবা নিচের মেনু থেকে বেছে নিন 👇",
            [["🔍 রক্তদাতা খুঁজুন", "📝 ডোনার নিবন্ধন"], ["🔄 প্রোফাইল আপডেট", "📅 শেষ দান আপডেট"], ["❓ সাহায্য", "🌐 ওয়েবসাইট"]]
        );
        // Keep the website button too for direct access
        await sendTgUrlButton(
            chatId,
            "সরাসরি ওয়েবসাইটে গিয়েও রক্তদাতা খুঁজতে পারেন:",
            "রক্তদাতা খুঁজুন →",
            `${process.env.FRONTEND_URL}/blood-donation`
        );
        return true;
